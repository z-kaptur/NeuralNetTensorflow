...
with tf.name_scope('Conv1'):
    ...
    yConv1 = tf.nn.relu(conv2d(xImage,weightsConv1) + biasesConv1, name="relu")
...
with tf.name_scope('Conv2'):
    ...
    yConv2 = tf.nn.relu(conv2d(yPool1,weightsConv2) + biasesConv2, name="relu")
...
with tf.name_scope('output'):
    ...
    yFC2 = tf.matmul(yFC1,weightsFC2)+biasesFC2
...
for i in range(num_steps):
    ...
    trainStep.run(feed_dict={x: batch[0], y_: batch[1], keepProb: 0.5})
